...
function Header() {
  return (
    <header className="flex justify-center items-center inset-x-0 max-w-3xl mx-auto mt-5 justify-between fixed z-50 rounded-full  px-5 min-h-16 text-yellow-50 bg-slate-700 "
    >
      <div>
