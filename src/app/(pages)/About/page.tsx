import Button from "../About/page"
import Image from "next/image"


function page() {
  return (
    <main className="h-auto w-full rounded-md relative overflow-hidden mx-auto py-10 md:py-0">

<div className="flex max-w-screen-lg h-auto justify-center items-center m-auto p-auto ">
  
     <div className="max-w-screen-md ">
     <p className="mt-36 text-2xl text-gray-400 ">OUR MISSION</p>
     <h1 className="mt-5 text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-blue-300 to-blue-950">
...
<div className="mt-20">
  <div className="max-w-4xl h-auto justify-center items-center mx-auto">
    <p className="text-center">Trusted by</p>
    <Image src={"https://www.skykick.com/wp-content/uploads/skykick-partner-logos-homepage-lockup-2023-2@2x-1536x206.png" } width={"800"} height={"500"}  alt="Company Logo"></Image>
  </div>
</div>


<div className="mt-56 flex justify-center items-center max-w-5xl mx-auto bg-gray-100 mb-10 h-auto p-10 rounded-xl">
  <div className="w-1/2">
    <p className="text-gray-400 ">WHAT WE DO</p>
    <p className="text-lg">Professionals worldwide use Venngage to communicate complex ideas through visuals. We believe everyone should be able to communicate like a designer, even without any design skills or experience. That’s why our driven Venngage team continues to raise the bar for design accessibility and effective communication for organizations big and small, around the world.</p>
    <button  className="bg-blue-500 text-white dark:text-white
        border-neutral-200 text-center  capitalize p-4 rounded-md text-lg mt-8 hover:drop-shadow-lg hover:bg-blue-950 shadow-lg shadow-blue-500/50 mb-5 ">VIEW OPEN POSITIONS</button>
  </div>
  <div>
...
<section className="w-full mt-20 bg-blue-200 h-auto flex justify-center flex-col items-center ">
  <div className="max-w-screen-lg mx-auto">
    <h1 className="text-center text-4xl font-semibold">Our Journey Over the Years</h1>
    ...
    <div className=" max-w-7xl mt-10 px-5 py-20 flex flex-col justify-center mx-auto  ">
      ...
      <div className="mt-14 h-auto w-16 flex flex-col justify-center items-center ml-5  ">
    ...
    <div className=" max-w-7xl mt-10 px-5 py-20 flex flex-col justify-center items-center mx-auto  ">
...
<div className="mt-8 h-auto w-16 flex flex-col justify-center items-center ml-5  ">
  <div className="border-x-inherit p-0">
    <div className="w-5 h-5 rounded-full bg-blue-400"dir="rtl flex"></div>
  </div>
  <div className=" border-r-2 border-black h-full m-auto mt-5"></div>
...
<div className=" max-w-7xl mt-10 px-5 py-20 flex flex-col justify-center items-end mx-auto  ">
...
<div className=" max-w-7xl mt-10 px-5 py-20 flex flex-col justify-end items-first mx-auto  ">
